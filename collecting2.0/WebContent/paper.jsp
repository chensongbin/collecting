...
<!-- paper-home -->
<div class="container" id="paper-home">
	<div class="row" style="margin-bottom: 50px;">
		<div class="col-md-1"></div>
		
		<div class="col-md-10" id="paper-main">
			
<div id="uniqueKey" style="display: none">${requestScope.uniqueKey}</div>
	<div class="row">
    	<h3 id="paper-title" class="text-center" data-toggle="modal" data-target="#revisde-paper-title-modal">${requestScope.paperTitle}</h3>
		<div class="col-md-2"></div>
		<div class="col-md-8">
			<form id="problems" class="form-group">
	        	${requestScope.paperHTML}        
	    	</form>
	    </div>
		<div class="col-md-2"></div>
	</div>
...
<script type="text/javascript">
	...
	$('#submit-btn').click(function() {
		var key = $('#uniqueKey').text().trim();
		var data = $('#problems').serialize();
		data = "uniqueKey="+ key + "&" + data;
		$.ajax({
			url: "/collecting2.0/SubmitPaper",
			type: "POST",//方法类型
			data: data,
