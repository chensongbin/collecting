...
<div id="home">
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-4">
				<h4>我是访客,我需要填写调查问卷</h4>
				<form  role='form' method="get" action="/collecting2.0/ShowPaper">
					<div class="input-group">
				      <input type="text" class="form-control" name='uniqueKey' placeholder="请输入问卷识别码">
...
<script src="js/LoginRegister.js" type="text/javascript" charset="utf-8"></script>
</body>
</html>